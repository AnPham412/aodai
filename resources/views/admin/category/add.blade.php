  ...
  <div class="main-content-wrap">
    ...
    <div class="wg-box">
      <form class="form-new-product form-style-1" action="{{route('admin.category.store')}}" method="POST"
        ...
        @error('name')<span class="aler alert-danger text-center"> {{$message}} </span>@enderror
        <fieldset class="name">
        ...
        @error('slug')<span class="aler alert-danger text-center"> {{$message}} </span>@enderror
        ...
        @error('image')<span class="aler alert-danger text-center"> {{$message}} </span>@enderror
